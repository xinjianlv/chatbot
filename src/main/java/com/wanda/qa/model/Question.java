...
import com.wanda.qa.filter.CandidateAnswerCanNotInQustionFilter;
import com.wanda.qa.filter.CandidateAnswerFilter;
...
public class Question {
    ...
    private QuestionType questionType = QuestionType.NULL; //QuestionType.PERSON_NAME;
